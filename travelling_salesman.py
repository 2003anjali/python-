...
enter the distance between the node1 and node2 :10
enter the distance between the node1 and node3 :15
enter the distance between the node1 and node4 :20
enter the distance between the node2 and node3 :9
enter the distance between the node2 and node4 :10
enter the distance between the node3 and node4 :12
Optimal drilling order :  [1, 2, 4, 3, 1]
Total Optimal cost :  47.0
Do you want to try again with a different number of nodes?yes/No no
'''